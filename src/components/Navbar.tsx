      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            {NAV_LINKS.map((item) => {
              ...
              return (
                <a
                  ...
                  className={`text-sm sm:text-[15px] tracking-wide transition-colors whitespace-nowrap relative ${
                    isActive
                ...
                >
                  ...
                  {isActive && (
                    <motion.span
                      ...
                      className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-neutral-900"
                    />
                  )}
                </a>
              );
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <a
            ...
            className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full text-neutral-800 hover:text-neutral-950 bg-white/80 hover:bg-white shadow-xs border border-neutral-200/80 hover:scale-105 transition-all"
          >
            <svg
            ...
            <div className="flex flex-col gap-2">
                  ...
                  <a
                    ...
                    className={`px-4 py-2.5 text-sm rounded-xl transition-all ${
                      isActive
                        ...
                        : 'text-neutral-700 hover:bg-neutral-100 font-normal'
                    }`}
                  >
                    {item.name}
                  </a>
              ...
              <div className="pt-3 mt-1 border-t border-neutral-100 flex items-center justify-around text-neutral-700">
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Instagram"
                  className="p-2 hover:text-neutral-950"
                >
