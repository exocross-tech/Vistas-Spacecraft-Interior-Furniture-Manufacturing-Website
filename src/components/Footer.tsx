    ...
    <footer className="w-full bg-[#121214] text-white border-t border-neutral-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 items-start">
          {/* Column 1: Brand Logo & Information (4 cols) */}
          ...
          {/* Column 2: Real-Time Interactive Google Map (4 cols) */}
          <div className="lg:col-span-4 flex flex-col">
            <h4 className="text-sm font-semibold uppercase tracking-wider text-neutral-200 mb-4">
              Factory Location Map
            </h4>
            <div className="relative w-full h-[220px] sm:h-[240px] rounded-2xl overflow-hidden border border-neutral-700/80 bg-neutral-900 shadow-inner group">
              {/* Google Map iframe */}
              <iframe
              ...
              <div className="absolute top-3 right-3 z-10">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-neutral-900/90 hover:bg-neutral-900 text-white text-[11px] font-medium border border-neutral-700/80 shadow-md transition-all hover:scale-105"
                >
              ...
              <div className="absolute bottom-3 left-3 z-10 pointer-events-none">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-950/85 backdrop-blur-sm border border-neutral-700/80 text-[11px] text-neutral-200">
                  <span className="w-2 h-2 rounded-full bg-[#8B7355] animate-pulse" />
                  <span>Phase II Facility</span>
                </div>
              </div>
            </div>
          </div>
