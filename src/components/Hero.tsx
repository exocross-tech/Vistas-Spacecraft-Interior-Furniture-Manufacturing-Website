...
export function Hero() {
  ...
  // Timed Pop-Up Modal State (4s on Mobile, 7s on Desktop)
  ...
  // Timed Pop-Up Modal Trigger: 4s on Mobile (<1024px), 7s on Desktop (>=1024px)
  useEffect(() => {
    if (typeof window === 'undefined') return;

    const isMobile = window.innerWidth < 1024;
    const modalDelay = isMobile ? 4000 : 7000;
  ...
  return (
    <section
      id="home"
      className="relative w-full min-h-[82dvh] sm:min-h-[85dvh] lg:min-h-screen flex flex-col justify-center overflow-hidden bg-[#140f0c]"
    >
      {/* ============================================================ */}
      ...
      <div
        className="absolute inset-0 pointer-events-none bg-gradient-to-r from-black/75 via-black/40 to-black/60"
        aria-hidden="true"
      />
      <div
        className="absolute inset-0 pointer-events-none bg-gradient-to-t from-[#140f0c] via-transparent to-black/50"
        aria-hidden="true"
      />

      {/* ============================================================ */}
      {/* Content Container (Padded for transparent fixed navbar) */}
      {/* ============================================================ */}
      <motion.div
        variants={containerVariants}
        initial="hidden"
        animate="visible"
        className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 pt-22 sm:pt-26 lg:pt-28 pb-8 sm:pb-12 flex flex-col justify-center"
      >
        {/* Full-Width Spacious Hero Editorial Layout */}
        <div className="max-w-2xl lg:max-w-3xl xl:max-w-4xl text-left space-y-4 sm:space-y-6">
          {/* Technical Eyebrow */}
          ...
          <motion.div variants={headingVariants}>
            <h1 className="text-3xl sm:text-4.5xl md:text-5.5xl lg:text-6.5xl xl:text-7xl font-serif font-bold text-white tracking-tight leading-[1.12] sm:leading-[1.06] drop-shadow-md">
          ...
          >
            ...
            <div className="flex items-center gap-2 bg-black/40 backdrop-blur-md px-3.5 py-2 rounded-full border border-white/15 shadow-md">
      ...
      {/* ============================================================ */}
      {/* Timed Quick Inquiry Modal (4s on Mobile, 7s on Desktop) */}
      {/* ============================================================ */}
      <AnimatePresence>
        {isModalOpen && (
          <div
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-md bg-neutral-950/95 border border-white/20 rounded-2xl p-5 sm:p-6 text-white shadow-2xl overflow-hidden"
            ...
            >
              ...
              <button
                ...
                className="absolute top-3.5 right-3.5 text-neutral-400 hover:text-white p-2 rounded-xl bg-neutral-900/80 hover:bg-neutral-800 transition-colors z-20 cursor-pointer"
              ...
              <div className="mb-3.5 text-left pr-8">
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  <h3 id="inquiry-modal-title" className="text-sm sm:text-base font-bold uppercase tracking-wider text-white font-serif">
                    QUICK INQUIRY
                  </h3>
                </div>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleInquirySubmit} className="space-y-3 text-left">
                  {/* Name Field */}
                  <div>
                    <label htmlFor="modal-name" className="block text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-neutral-300 mb-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    {/* Email */}
                    <div>
                      <label htmlFor="modal-email" className="block text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-neutral-300 mb-1">
                    ...
                    {/* Phone */}
                    <div>
                      <label htmlFor="modal-phone" className="block text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-neutral-300 mb-1">
                  ...
                  <div>
                    <label htmlFor="modal-service" className="block text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-neutral-300 mb-1">
                  ...
                  {/* Message Field */}
                  <div>
                    <label htmlFor="modal-message" className="block text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-neutral-300 mb-1">
                      MESSAGE
                    </label>
                    <div className="relative">
